...
INSTAGRAM_USERNAME = os.getenv("revenia.agency")
INSTAGRAM_PASSWORD = os.getenv("ArusyLosScoutssonunasecta")

if not INSTAGRAM_USERNAME or not INSTAGRAM_PASSWORD:
    raise ValueError("Las variables de entorno INSTAGRAM_USERNAME e INSTAGRAM_PASSWORD no están definidas")
